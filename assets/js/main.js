...
function isMobile() {
    return window.innerWidth <= 768; // Ajusta este valor si es necesario
}

// Función para actualizar los href de los enlaces y el botón
function updateLinkHref() {
    ...
    // Modificar el botón "Saber Más"
    var saberMasBtn = document.getElementById('saber-mas-btn');
    if (saberMasBtn) {
        if (isMobile()) {
            saberMasBtn.setAttribute('href', '#benmob');
        } else {
            saberMasBtn.setAttribute('href', '#beneficios');
        }
    }
}
